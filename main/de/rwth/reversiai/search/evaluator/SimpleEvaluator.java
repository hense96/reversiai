 ...
 * It uses SimpleHeuristics from Assignment 2.
 */
public class SimpleEvaluator extends Evaluator< ParanoidDouble >
{
    @Override
    public ParanoidDouble evaluate( GameTree.Node node )
    {
        ...
        {
            eval = new ParanoidDouble(
                    SimpleHeuristics.relativeNumberOfMoves( state, this.gameTree.getMaxPlayer(), 0.5 ),
                    this.gameTree.getMaxPlayer()
            );
        }
